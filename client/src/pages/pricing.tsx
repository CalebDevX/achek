      ...
      if (window.FlutterwaveCheckout) {
        ...
        window.FlutterwaveCheckout({
          ...
          callback: function (response) {
            setLoading(false);
            setSuccess(true);
            // TODO: Send receipt to email via backend
            // Example: Call backend API to send receipt
            ...
            // You can further automate notifications, CRM, etc. here
          },
          onclose: function () {
            setLoading(false);
          },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
              Choose the service you need and pay securely online. Our team will contact you immediately to deliver your selected service and send a receipt to your email.
            </p>
            {/* Category Tabs */}
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 dark:bg-black dark:bg-opacity-70">
          <div className="bg-white dark:bg-zinc-900 rounded-xl shadow-2xl p-8 w-full max-w-md">
            {!success ? (
              <>
                <h2 className="text-2xl font-bold mb-4 text-foreground">Pay for {selectedService?.name}</h2>
